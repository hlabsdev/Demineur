...
namespace AutoVersion{
	...
	static const long REVISION  = 1799;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 468;
	#define RC_FILEVERSION 1,3,342,1799
	#define RC_FILEVERSION_STRING "1, 3, 342, 1799\0"
	static const char FULLVERSION_STRING [] = "1.3.342.1799";
